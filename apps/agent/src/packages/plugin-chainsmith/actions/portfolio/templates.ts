...
Analyze the following portfolio report and provide an evaluation below. 
  ...
  - summary: A string contains 2-3 sentences summarize and evaluate the current allocation, and why it has the above score. Token symbol MUST be added with '$' at the beginning ($ETH, $BTC, $SOL, $USDC...)
  - successActions: a list of recommended actions (string only) that contains description and % of allocation that investor should consider. Token symbol MUST be added with '$' at the beginning ($ETH, $BTC, $SOL, $USDC...)
