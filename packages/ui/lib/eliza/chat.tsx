...
import { ChatBubble, ChatBubbleMessage, ChatBubbleTimestamp } from './chat/chat-bubble';
...
import { useAutoScroll } from '@/core';
...
export default function ChatPage({ agentId }: { agentId: UUID }) {
  ...
  const sendMessageMutation = useMutation({
    ...
    mutationFn: ({ message, selectedFile }: { message: string; selectedFile?: File | null }) =>
      agentService.sendMessage(agentId, message, selectedFile),
  ...
  return (
    <div className="flex flex-col w-full h-[calc(100dvh)] p-4 bg-white">
